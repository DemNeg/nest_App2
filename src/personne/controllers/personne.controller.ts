...
export class PersonneController {
    ...
    @Put('miseAjour/:id')
    miseAjourPersonne(@Param('id',ParseIntPipe)personneId,@Body()newPersonne:PersonneEditDto){
    ...
    editPartiellePersonne(@Param('id',ParseIntPipe)personneId,@Body()newPersonne:Partial<PersonneEditDto>){
